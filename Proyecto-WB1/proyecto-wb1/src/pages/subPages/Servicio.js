/// src/pages/subPages/Servicios.js
...
const Servicio = () => {
    ...
    //const itemsCollectionRef = collection(db, "servicios");
    ...
    const handleAddItem = async () => {
        if (newItem.name && newItem.price) {
            ...
            await addDoc(historialCollectionRef, { name: `Servicio: ${newItem.name}`, amount: parseFloat(newItem.price), date: new Date() });
    ...
    const handlePriceChange = async (id, newPrice) => {
        ...
        await addDoc(historialCollectionRef, { name: `Actualización de Servicio`, amount: parseFloat(newPrice), date: new Date() });
    ...
    return (
        <div>
            ...
            <Container className="mt-5 text-center">
                <h2>Tipos de servicios con los que se cuentan y su gasto (agua, luz, internet, cable, teléfono)</h2>
